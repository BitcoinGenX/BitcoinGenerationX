Contributing to BitcoinGenX Core
============================

The BitcoinGenX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinGenX Core project, and is not to be
confused with overall bitcoingenx Network Protocol consensus changes.

Whether a pull request is merged into BitcoinGenX Core rests with the project merge
...
Patches that change bitcoingenx consensus rules are considerably more involved than
...
Where a patch set proposes to change the bitcoingenx consensus, it must have been
...
The project leader is the release manager for each BitcoinGenX Core release.
