...
In order to support loading of multiple wallets in bitcoingenx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoingenx.cpp.
...
Changes to bitcoingenx.cpp
----------------------
bitcoingenx.cpp is the entry point into bitcoingenx-qt, and as such, will require some minor modifications to provide hooks for
