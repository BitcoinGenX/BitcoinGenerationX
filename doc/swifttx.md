...
This mechanism has been integrated into Bitcore-Node-bitcoingenx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoingenx-Project/insight-api-bitcoingenx#web-socket-api](https://github.com/bitcoingenx-Project/insight-api-bitcoingenx#web-socket-api) 
* API: [https://github.com/bitcoingenx-Project/insight-api-bitcoingenx#swifttx-transactions](https://github.com/bitcoingenx-Project/insight-api-bitcoingenx#swifttx-transactions) 
...
By default, the BitcoinGenX Core daemon will launch using the following constant:

```
static const int DEFAULT_RHENFAST_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitcoinGenX Core daemon:
