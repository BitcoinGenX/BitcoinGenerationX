...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/bitcoingenx-Project/bitcoingenx/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign BitcoinGenX Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit bitcoingenx=v${VERSION} ../bitcoingenx/contrib/gitian-descriptors/gitian-win.yml
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import bitcoingenx/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
- Detached signatures will then be committed to the [bitcoingenx-detached-sigs](https://github.com/bitcoingenx-Project/bitcoingenx-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the bitcoingenx.org server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/bitcoingenx-Project/bitcoingenx/releases/new) with a link to the archived release notes.
