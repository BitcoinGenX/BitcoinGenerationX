...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcoinGenX Core bitcoingenx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoingenx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoingenx transaction") + "\n" +
                               "  bitcoingenx-tx [options] -create [commands]   " + _("Create hex-encoded bitcoingenx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoingenx transaction
