/* src/config/bitcoingenx-config.h.  Generated from bitcoingenx-config.h.in by configure.  */
/* src/config/bitcoingenx-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define this symbol if you have MSG_BGXIGNAL */
/* #undef HAVE_MSG_BGXIGNAL */
...
#define PACKAGE_BUGREPORT "www.bitcoingenx.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinGenX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinGenX Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoingenx"
