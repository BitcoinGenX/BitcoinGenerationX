                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitcoinGenX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a bitcoingenx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoingenx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBGX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitcoinGenX Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinGenX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for bitcoingenx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your bitcoingenx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified bitcoingenx addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagbitcoingenxtic information"));
    ...
    openAction->setStatusTip(tr("Open a bitcoingenx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinGenX Core help message to get a list with possible bitcoingenx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitcoinGenX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to bitcoingenx network", "", count));
}
...
{
    QString strTitle = tr("BitcoinGenX Core"); // default title
...
/** Creates context menu, its actions, and bitcoingenxs up all the relevant signals for mouse events. */
