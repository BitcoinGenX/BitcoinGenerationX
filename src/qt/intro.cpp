...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinGenX Core"),
     ...
     * override -datadir in the bitcoingenx.conf file in the default data directory
     * (to be consistent with bitcoingenxd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
