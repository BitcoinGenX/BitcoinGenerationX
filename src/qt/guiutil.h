...
/** Utility functions used by the bitcoingenx Qt UI.
 */
namespace GUIUtil
{
...
// Render bitcoingenx addresses in mobitcoingenxpace font
...
// Parse "bitcoingenx:" URI into recipient object, return true on successful parsing
