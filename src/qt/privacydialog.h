...
public:
    ...
    void setZbitcoingenxControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBGX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBGX_clicked();
    void on_pushButtonZbitcoingenxControl_clicked();
