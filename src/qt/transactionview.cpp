                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received bitcoingenx from zbitcoingenx"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zbitcoingenx"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zbitcoingenx));
