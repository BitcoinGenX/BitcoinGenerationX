...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop bitcoingenx server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "bitcoingenx server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* bitcoingenx features */
        {"bitcoingenx", "masternode", &masternode, true, true, false},
        {"bitcoingenx", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoingenx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoingenx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoingenx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoingenx", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoingenx", "startmasternode", &startmasternode, true, true, false},
        {"bitcoingenx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoingenx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoingenx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoingenx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoingenx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoingenx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoingenx", "mnbudget", &mnbudget, true, true, false},
        {"bitcoingenx", "preparebudget", &preparebudget, true, true, false},
        {"bitcoingenx", "submitbudget", &submitbudget, true, true, false},
        {"bitcoingenx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoingenx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoingenx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoingenx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoingenx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoingenx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoingenx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoingenx", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoingenx", "mnsync", &mnsync, true, true, false},
        {"bitcoingenx", "spork", &spork, true, true, false},
        {"bitcoingenx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitcoingenx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcoingenxd, or the -server option to bitcoingenx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitcoingenx-cli " + methodname + " " + args + "\n";
}
