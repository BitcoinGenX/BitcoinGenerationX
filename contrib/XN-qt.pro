...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcoingenx-config.h \
           src/crypto/common.h \
...
RESOURCES += src/qt/bitcoingenx.qrc src/qt/bitcoingenx_locale.qrc

TRANSLATIONS += src/qt/locale/bitcoingenx_bg.ts \
                src/qt/locale/bitcoingenx_de.ts \
                src/qt/locale/bitcoingenx_en.ts \
                src/qt/locale/bitcoingenx_es.ts \
                src/qt/locale/bitcoingenx_fi.ts \
                src/qt/locale/bitcoingenx_fr.ts \
                src/qt/locale/bitcoingenx_it.ts \
                src/qt/locale/bitcoingenx_ja.ts \
                src/qt/locale/bitcoingenx_pl.ts \
                src/qt/locale/bitcoingenx_pt.ts \
                src/qt/locale/bitcoingenx_ru.ts \
                src/qt/locale/bitcoingenx_sk.ts \
                src/qt/locale/bitcoingenx_sv.ts \
                src/qt/locale/bitcoingenx_vi.ts \
                src/qt/locale/bitcoingenx_zh_CN.ts \
                src/qt/locale/bitcoingenx_zh_TW.ts
